		...
		<div id="in--header">
			...
			<div id="icon--container">
				...
				<div class="hd-menubtn menubtn">
					<div class="m_menu">
						<div class="menubar">
							<span class="bar bar01"></span> <span class="bar bar02"></span> <span class="bar bar03"></span>
						</div>
						<div class="gnb-all">
		...
		$(document)
				.ready(
						function() {
							...
							$("header .gnb-wrap .gnb > li").mouseover(
									function() {
							...
							if (matchMedia("screen and (max-width: 1920px)").matches) {
								...
								$(".menubar")
										.click(
												function() {
													...
													$(".all-bg").toggle();
													$(
															".all-menu > ul > li:not(.gnb-sns) > ul")
															.slideUp();
													$(
															".all-menu > ul > li:not(.gnb-sns) > ul")
															.slideUp();
													$(
															".all-menu > ul > li:not(.gnb-sns) a")
															.removeClass("on");
												});
								$(".all-menu > ul > li:not(.gnb-sns) > ul")
										.addClass("dep2");
										...
										.click(
												function() {
													...
													$(
															...
															.slideUp();
													$(
															".all-menu > ul > li:not(.gnb-sns) > ul.dep2 ul")
															.stop().slideUp();
													if (!$(this).parent().find(
															".dep2").is(
															":visible")) {
								...
								$(
										...
										.click(
												function() {
													$(
															".all-menu > ul > li:not(.gnb-sns) > ul > li.dep3 > a")
															.removeClass("on");
													$(
															".all-menu > ul > li:not(.gnb-sns) > ul.dep2 ul")
															.stop().slideUp();
