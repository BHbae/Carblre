        ...
        <div class="sub--content">
            ...
            <div id="user-login-form" class="login-form infoupdate">
                ...
                <form action="/user/signIn" method="POST">
                    <input type="text" name="nickName" placeholder="ID" style="margin-bottom: 10px;" required value="test1">
                    <input type="password" name="password" placeholder="비밀번호" required value="asd123!!">
