...
import com.carblre.dto.ValidationCodeDTO;
import com.carblre.service.EmailService;
...
public class EmailController {
    ...
    /**
     * ****** !이메일 인증 로직 시작! ******
     * signUp.jsp에서 발송 버튼을 누르면 email의 값을 fetch를 통해 받아옵니다.
    ...
    public ResponseEntity<Map<String, String>> findPasswordByEmail(@RequestParam("email") String email,
        ...
        ValidationCodeDTO.builder()
                .email(email)
                .validationCode(findPasswordByEmailCode)
                .expirationTime(MAX_VALIDATE_TIME)
                .build();
